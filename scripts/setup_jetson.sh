...
sudo apt-get update
sudo apt-get install -y nvidia-jetpack python3-venv python3-pip python3-opencv python3-numpy python3-tk python3-pil.imagetk uvcdynctrl v4l-utils usbutils wget
if [[ ! -d .venv ]]; then
